...
<p style="color:green;font-weight:bold;">To add a New Book please click <a href="<c:url value='/admin/index' />" >
	<img src="<c:url value='/images/vcard_add.png' />" title="Add a New Book"/>
</a>
</p>
<c:url var="action" value="/admin/book/add.html" ></c:url>
<form:form method="post" action="${action}" commandName="book" cssClass="bookForm">
	<table style="height: 600;width: 600px">
